/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c47e16755c47da3f573d0f329cc5eb67)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	ASSETS: Fetcher;
	ENVIRONMENT_NAME: "qa" | "pilot" | "production";
	V3_CUTOVER_DATE: "2026-08-11";
	V3_SOURCE_SCHEMA_FINGERPRINT: "e3f4e50e61a773910de265e3e2a30a97c58b9963f2da301272ccd04cb4666d17";
	DYNAMIC_SCHEDULER_SHADOW_ENABLED: "true";
	DYNAMIC_SCHEDULER_DEPENDENCY_REVIEW_ENABLED: "true";
	DYNAMIC_SCHEDULER_OFFICIAL_APPLY_ENABLED: "true";
	DYNAMIC_SCHEDULER_AUTO_APPLY_ENABLED: "false";
	DYNAMIC_SCHEDULER_APPROVAL_ENABLED: "true";
	DYNAMIC_SCHEDULER_RESTORE_ENABLED: "true";
	PILOT_SESSION_AUTH_ENABLED: "false";
	SCHEDULER_ACCESS_MODE: "open_test" | "internal_trust";
	TEST_ACTOR_MODE: "false";
	QA_TEST_CLOCK_ENABLED?: "true" | "false";
	PILOT_SESSION_TTL_SECONDS: "43200";
	BUILD_SHA?: "7c96e690c834339e9dae68df1542cb10a8b24e42";
	BUILD_TIMESTAMP?: "2026-08-14T19:31:00+09:00";
}
declare namespace Cloudflare {
	...
	interface QaEnv {
		...
		DYNAMIC_SCHEDULER_RESTORE_ENABLED: "true";
		PILOT_SESSION_AUTH_ENABLED: "false";
		SCHEDULER_ACCESS_MODE: "open_test";
		TEST_ACTOR_MODE: "false";
		QA_TEST_CLOCK_ENABLED: "true";
		PILOT_SESSION_TTL_SECONDS: "43200";
	}
	interface PilotEnv {
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT_NAME" | "V3_CUTOVER_DATE" | "V3_SOURCE_SCHEMA_FINGERPRINT" | "DYNAMIC_SCHEDULER_SHADOW_ENABLED" | "DYNAMIC_SCHEDULER_DEPENDENCY_REVIEW_ENABLED" | "DYNAMIC_SCHEDULER_OFFICIAL_APPLY_ENABLED" | "DYNAMIC_SCHEDULER_AUTO_APPLY_ENABLED" | "DYNAMIC_SCHEDULER_APPROVAL_ENABLED" | "DYNAMIC_SCHEDULER_RESTORE_ENABLED" | "PILOT_SESSION_AUTH_ENABLED" | "SCHEDULER_ACCESS_MODE" | "TEST_ACTOR_MODE" | "QA_TEST_CLOCK_ENABLED" | "PILOT_SESSION_TTL_SECONDS" | "BUILD_SHA" | "BUILD_TIMESTAMP">> {}
}
