...
export function ManagerOperationsPage() {
  ...
  return <main className="min-h-screen bg-slate-50 px-4 py-6 sm:px-6">
    <div className="mx-auto max-w-7xl space-y-6">
      <div className="flex justify-end">{canManage ? <Link to="/manager/worklog-approvals" className="rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white">업무일지 승인</Link> : <span className="rounded-lg border border-slate-200 bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-500">VIEWER · Read only</span>}</div>
