...
cmd /c "npx playwright test tests/e2e/gantt-inline-content.spec.ts tests/e2e/project-actions-regression.spec.ts tests/e2e/task-modal-runtime.spec.ts tests/e2e/mobile-logo-header.spec.ts tests/e2e/vietnam-saturday-calendar.spec.ts"
if ($LASTEXITCODE -ne 0) {
